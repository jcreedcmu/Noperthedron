...
on real solution-table rows, so that `lake build VerifiedKernel` actually
...
namespace Noperthedron.Verified.Kernel.Smoke
...
/-- info: 'Noperthedron.Verified.Kernel.Smoke.csvRows_8018_8023_leafOk' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms csvRows_8018_8023_leafOk

/-- info: 'Noperthedron.Verified.Kernel.Smoke.csvRows_1008268_1008269_leafOk' depends on axioms: [propext,
 Classical.choice,
 Quot.sound] -/
#guard_msgs in
#print axioms csvRows_1008268_1008269_leafOk

/-- info: 'Noperthedron.Verified.Kernel.Smoke.prefix_row0_interval' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
#print axioms prefix_row0_interval

/-- info: 'Noperthedron.Verified.Kernel.Smoke.prefix_first_splits_validIx' depends on axioms: [propext,
 Classical.choice,
 Quot.sound] -/
#guard_msgs in
#print axioms prefix_first_splits_validIx

end Noperthedron.Verified.Kernel.Smoke
