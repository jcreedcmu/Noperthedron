#!/usr/bin/env python3
"""Exact coordinate and vertex generator for Nopert #228 (Candidate R8).
...
R2_UNSCALED = (-0.17498349913916189, 0.95974981796212366, 0.30745142339957682)
R3_UNSCALED = (0.043880343662019643, 0.58185156273199845, 0.5800230814679902)

# Candidate R8 azimuth rotation: delta = -1e-3 rad on Ring 1
DELTA = -1e-3
c_d = math.cos(DELTA)
s_d = math.sin(DELTA)
...
C1 = (R2_UNSCALED[0] - R0_UNSCALED[0]) * dy_rot - (R2_UNSCALED[1] - R0_UNSCALED[1]) * dx_rot
C2 = (R2_UNSCALED[2] - R0_UNSCALED[2]) * ((R1_X_UNSCALED - R0_UNSCALED[0]) * dy_rot - (R1_Y_UNSCALED - R0_UNSCALED[1]) * dx_rot)
R1_Z_UNSCALED = R0_UNSCALED[2] + C2 / C1

# Order seeds by decreasing z convention (matching Nopert214 / Nopert76):
# Seed 0: Level 3 (top cap, z ~ +0.58)
# Seed 1: Level 2 (ring 2,  z ~ +0.31)
# Seed 2: Level 1 (ring 1,  z ~ -0.04)
# Seed 3: Level 0 (bot cap, z ~ -0.78)
RAW_SEEDS = (
    R3_UNSCALED,
    R2_UNSCALED,
...
if __name__ == "__main__":
    print("Nopert #228 Coordinates (repair214 exact derivation):")
