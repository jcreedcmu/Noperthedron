#!/usr/bin/env python3
"""Emit exact tangent-cone certificates for the Nopert #228 checker model.
...
from nopert228_vertices import VERTICES_Q
...
def emit(destination: Path):
    ...
    lines = [
        "module", "",
        "public import Noperthedron.Nopert228.SparseSupport",
        "public meta import Noperthedron.Nopert228.SparseSupport", "",
        "@[expose] public section", "",
        "namespace Noperthedron.Nopert228.GeneratedTangentCones", "",
    ...
    lines.extend([
        ...
        "  native_decide", "",
        "end Noperthedron.Nopert228.GeneratedTangentCones", "", "end", "",
    ])
