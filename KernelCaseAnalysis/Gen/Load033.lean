...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [1081344, 1114112) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 1081344 to 1114112 chunkSize 512
