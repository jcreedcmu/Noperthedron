...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [581632, 589824) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 581632 to 589824 chunkSize 512
