...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [1327104, 1335296) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 1327104 to 1335296 chunkSize 512
