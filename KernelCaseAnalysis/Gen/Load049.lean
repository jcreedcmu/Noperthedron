...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [802816, 819200) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 802816 to 819200 chunkSize 512
