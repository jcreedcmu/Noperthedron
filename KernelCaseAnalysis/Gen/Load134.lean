...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [1097728, 1105920) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 1097728 to 1105920 chunkSize 512
