...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [983040, 1015808) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 983040 to 1015808 chunkSize 512
