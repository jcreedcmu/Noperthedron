...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [2031616, 2048000) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 2031616 to 2048000 chunkSize 512
