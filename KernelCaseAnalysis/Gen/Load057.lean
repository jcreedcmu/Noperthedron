...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [466944, 475136) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 466944 to 475136 chunkSize 512
