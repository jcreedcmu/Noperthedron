...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [1466368, 1474560) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 1466368 to 1474560 chunkSize 512
