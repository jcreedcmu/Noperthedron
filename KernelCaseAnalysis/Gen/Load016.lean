...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [131072, 139264) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 131072 to 139264 chunkSize 512
