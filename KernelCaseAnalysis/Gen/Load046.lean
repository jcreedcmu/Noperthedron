...
/-! GENERATED (scripts/gen_kernel_chunks.py): rows [376832, 385024) of the solution
tree as literal 512-row chunks. Requires `solution_tree_v6.csv` at the repo
root. -/

namespace Noperthedron.Solution

load_csv_chunks_curried "solution_tree_v6.csv" from 376832 to 385024 chunkSize 512
