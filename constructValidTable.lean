...
/-!
  ...
  Running on the solution tree from solution_tree_v5.zip takes about 60 minutes on
  a 16-core machine.

  To get the solution tree, make sure you have git-lfs installed and you've fetched
  the full solution_tree_v5.zip file. then unzip it into solution_tree_v5.csv.
-/
