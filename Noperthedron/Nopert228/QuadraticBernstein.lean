...
quadratic representation used by the Nopert #228 atlas checker.
-/

namespace Noperthedron.Nopert228.QuadraticBernstein
...
end Noperthedron.Nopert228.QuadraticBernstein
