...
public import Noperthedron.Nopert228.LocalCertificate
...
namespace Noperthedron.Nopert228.AtlasLocalCertificate
...
theorem Box.valid_axisAngle_ratio (box : Box) (h : box.Valid)
  ...
  apply Noperthedron.Nopert228.AxisAngle.ratio_of_inner_mismatch_bound
...
theorem Box.valid_imp_not_translated_rupert (box : Box) (h : box.Valid) :
  ...
  apply
    Noperthedron.Nopert228.not_rupertPose_of_axisFree_symmetry_certificates_of_cover_perturbation
...
end Noperthedron.Nopert228.AtlasLocalCertificate
