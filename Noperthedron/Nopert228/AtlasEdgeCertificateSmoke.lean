...
public meta import Noperthedron.Nopert228.AtlasEdgeCertificate

@[expose] public section

/-! # Dual-evaluator smoke test for a charted edge-cycle row -/

namespace Noperthedron.Nopert228.AtlasEdgeCertificateSmoke
...
end Noperthedron.Nopert228.AtlasEdgeCertificateSmoke
