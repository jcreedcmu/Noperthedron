...
private lemma second_partials_key {pbar : Pose ℝ} {εα εθ₁ εφ₁ εθ₂ εφ₂ : ℝ} {ι : Type} [Fintype ι] [Nonempty ι]
  ...
  have hf_smooth : ContDiff ℝ 2 (rotproj_inner pc.S pc.w) := ContDiff.rotproj_inner pc.S pc.w
...
private lemma second_partials_key_outer {pbar : Pose ℝ} {εα εθ₁ εφ₁ εθ₂ εφ₂ : ℝ} {ι : Type} [Fintype ι] [Nonempty ι]
  ...
  have hf_smooth : ContDiff ℝ 2 (fun z : ℝ² => ⟪rotM (z.ofLp 0) (z.ofLp 1) P, pc.w⟫) :=
    ContDiff.inner ℝ (ContDiff.rotM_outer P) contDiff_const
