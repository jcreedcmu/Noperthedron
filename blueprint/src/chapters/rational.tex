...
\begin{lemma} \label{lem:A_lt_deltamn}
...
\begin{proof}
\uses{lem:kappa7,lem:A_lt_deltamn}
    For fixed $x,y$ every entry of $A(x,y)-A_{\mathbb{Q}}(x,y)$ is of the form
    ...
    \end{align*}
    So we can apply \cref{lem:A_lt_deltamn} and obtain that $\|A(x,y)-A_{\Q}(x,y)\|<\kappa/3\cdot \sqrt{3\cdot 3}=\kappa$.
\end{proof}
