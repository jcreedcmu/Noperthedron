...
\lean{RationalApprox.GlobalTheorem.rational_global}
    ...
    \begin{align*}
        ...
        &- \frac{\epsilon^2}{2}\cdot\big(|\langle R_{\Q}(\alphab) \Mib \widetilde{S},w \rangle|
          + 2|\langle R_{\Q}'(\alphab) \Mib^\theta \widetilde{S},w \rangle| + 2|\langle R_{\Q}'(\alphab) \Mib^\phi \widetilde{S},w \rangle|\\
        &\qquad\quad + |\langle R_{\Q}(\alphab) \Mib^{\theta\theta} \widetilde{S},w \rangle| + 2|\langle R_{\Q}(\alphab) \Mib^{\theta\phi} \widetilde{S},w \rangle| + |\langle R_{\Q}(\alphab) \Mib^{\phi\phi} \widetilde{S},w \rangle|\big)\\
        & \hspace{9cm}- 9\epsilon^3/2 - 4\kappa \big( 1 + 3 \epsilon + \tfrac92\epsilon^2\big),\\
        H^{\Q}_P \coloneqq{}& \langle \Miib P,w \rangle + \epsilon\cdot\big(|\langle \Miib^\theta P,w \rangle|+|\langle  \Miib^\varphi P,w \rangle|\big)\\
        &+ \frac{\epsilon^2}{2}\cdot\big(|\langle \Miib^{\theta\theta} P,w \rangle| + 2|\langle \Miib^{\theta\phi} P,w \rangle| + |\langle \Miib^{\phi\phi} P,w \rangle|\big) + \frac{4\epsilon^3}{3} + 3\kappa( 1+2\epsilon+2\epsilon^2).
    \end{align*}
