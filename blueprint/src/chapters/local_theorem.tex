...
\begin{lemma} \label{lem:coss}
    Let $\epsilon>0$ and $\theta,\thetab, \phi, \phib \in \R$ with $|\theta - \overline{\theta}|, |\phi - \overline{\phi}| \leq \epsilon$. Define $M = M(\theta, \phi)$ and $\overline{M} = M(\thetab, \phib)$ and let $P, Q \in \R^3$ with $\|P\|, \|Q\| \leq 1$. Then:
    \[
...
\begin{proof}
\uses{lem:langles,lem:XPgt0,lem:eps-spanning,lem:MP>r,lem:inCirc,lem:coss,lem:LMD,lem:pythagoras}
