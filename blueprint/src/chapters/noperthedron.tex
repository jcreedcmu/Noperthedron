...
\lean{Noperthedron.exactVertex_radius_one}
\leanok
The radius of the Noperthedron is one.
\end{lemma}
\begin{proof}
\leanok
\uses{c1_c2_c3_norms, thm:polyhedron_radius_iff, lemma:nopert_verts_norm_le_one}
By \cref{c1_c2_c3_norms}, \cref{thm:pointsymmetrize_pres_radius},
