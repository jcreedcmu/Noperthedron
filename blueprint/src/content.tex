...
By \ref{thm:rupert_iff_rupert_set} it suffices to show that the convex hull of
the noperthedron vertices is not a Rupert set. But this is exactly what \ref{thm:nopert_not_rupert_set} shows.
\end{proof}
